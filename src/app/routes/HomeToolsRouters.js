...
router.get('/membersHistory', homeControllers.membersHistoryView);
router.post('/editMembers/:NIP', homeControllers.editMembers);
router.get('/monetaryContribution', homeControllers.monetarycontributionview);
router.post('/contributionGrade', homeControllers.contributionGrade);
router.get('/contributionDelete/:Id', homeControllers.contributionDelete);
