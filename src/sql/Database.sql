...
-- GROUP CREATION --
INSERT INTO Grupos(IdGrupo, Nombre)
VALUES
(1, 'Grupo Juvenil');


--SUPERUSER CREATION--
INSERT INTO Integrantes(NIP, IdGrupo, td, NombreCompleto, barrio, municipio, direccion, telefono, celular, email, nacimiento, sexo, CondicionUsuario, EstadoMiembro)
VALUES
(1, 1, 'AD', 'ADMIN', 'ADMIN', 'ADMIN', 'ADMIN', 'ADMIN', 'ADMIN', 'ADMIN', '2021-06-29', 'B', 1, 1);

INSERT INTO users(NIP, User, Pass, Question, Answer, SuperUser)
VALUES
(1, 'ADMIN', '$2a$08$uoY9S9WUHSQHX.qkNkcneeC1.iD31CeIqe5.rrhNI2/I2QZKWrHJ6', 'ADMIN', '$2a$08$uoY9S9WUHSQHX.qkNkcneeC1.iD31CeIqe5.rrhNI2/I2QZKWrHJ6', 1);
